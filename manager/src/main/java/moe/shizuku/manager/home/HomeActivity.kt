        ...
        return when (item.itemId) {
            R.id.action_about -> {
                ...
                binding.sourceCode.text = getString(
                    ...
                    "<b><a href=\"https://github.com/chumianyi/shizLite\">shizLite GitHub</a></b><br>" +
                        "基于 <a href=\"https://github.com/RikkaApps/Shizuku\">Shizuku</a> 原理开发，遵循 GPL-3.0 协议<br>" +
                        "本版本优化：精简激活方式（仅无线调试+Root）、新增模块系统（.slm）、M3 UI重构"
                ).toHtml()
            ...
            R.id.action_modules -> {
                startActivity(Intent(this, moe.shizuku.manager.module.ModuleActivity::class.java))
                true
            }
