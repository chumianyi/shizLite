...
public class BinderSender {
    ...
    private static final String PERMISSION_MANAGER = "com.chumian.shizlite.permission.MANAGER";
    private static final String PERMISSION = "com.chumian.shizlite.permission.API_V23";
